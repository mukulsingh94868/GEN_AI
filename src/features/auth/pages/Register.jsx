            ...
            <div className='auth-shell'>
                ...
                <aside className='auth-brand'>
                    ...
                    <div className='auth-brand__content'>
                        ...
                        <p>Your AI co-pilot for landing the job — build a winning interview strategy in minutes.</p>
                    </div>
                ...
                <main className='auth-panel'>
                    <div className='auth-card'>
                        <header className='auth-card__header'>
                            <span className='auth-card__eyebrow'>Get started free</span>
                            <h2>Create your account</h2>
                            <p>Join InterviewGenie and prepare with confidence.</p>
                        </header>
