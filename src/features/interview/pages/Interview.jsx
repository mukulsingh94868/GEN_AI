...
const Interview = () => {
    ...
    const actions = (
        <>
            ...
            <button
                type='button'
                onClick={() => navigate(`/mock-interview?reportId=${interviewId}`)}
                className='button primary-button interview-nav__practice'>
                        ...
                        <section>
                            <div className='content-header'>
                                <div className='content-header__title'>
                                    <span className='content-header__icon'>
                                    ...
                                    <div>
                                        ...
                                        <p>Deep-dive problems and expected answers for this role.</p>
                                    </div>
                                </div>
                            ...
                            <div className='content-header'>
                                <div className='content-header__title'>
                                    ...
                                    <div>
                                        ...
                                        <p>Star-format stories that showcase your soft skills.</p>
                                    </div>
                                </div>
                            ...
                            <div className='content-header'>
                                <div className='content-header__title'>
                                    ...
                                    <div>
                                        ...
                                        <p>A day-by-day plan to close your gaps before the interview.</p>
                                    </div>
                                </div>
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='match-score'>
                        ...
                        <div
                            ...
                            style={{ background: `conic-gradient(${ringColor} ${score * 3.6}deg, rgba(148,163,184,0.12) 0deg)` }}
                        >
