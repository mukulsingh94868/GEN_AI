...
export const useMockInterview = () => {
    ...
    const startMockInterview = async ({ interviewReportId, interviewType, difficulty, totalQuestions }) => {
        try {
            const data = await createMockInterview({ interviewReportId, interviewType, difficulty, totalQuestions });
